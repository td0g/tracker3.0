...
; Generated by Tyler Gerritsen on 2018-12-15 (UTC)
;
[Setup]
AppID={{f3513d48-6d16-447e-a38b-c792be653173}
AppName=ASCOM DeE Telescope Driver
AppVerName=ASCOM DeE Telescope Driver 3.1
AppVersion=3.1
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Telescope\DeE"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Telescope\DeE"
...
[Files]
Source: "C:\Users\Tyler\Documents\Visual Studio 2015\Projects\DeE\DeE\bin\Release\ASCOM.DeE.exe"; DestDir: "{app}" 

; TODO: Add driver assemblies into the ServedClasses folder   
Source: "C:\Users\Tyler\Documents\Visual Studio 2015\Projects\DeE\DeE\bin\Release\ASCOM.DeE.Telescope.dll"; DestDir: "{app}"   
Source: "C:\Users\Tyler\Documents\Visual Studio 2015\Projects\DeE\DeE\bin\Release\ASCOM.DeE.Focuser.dll"; DestDir: "{app}"
...
Source: "C:\Users\Tyler\Documents\Visual Studio 2015\Projects\DeE\DeE\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*; DestDir: "{app}\Source\DeE Driver"; Tasks: source; Flags: recursesubdirs
...
Filename: "{app}\ASCOM.DeE.exe"; Parameters: "/register"

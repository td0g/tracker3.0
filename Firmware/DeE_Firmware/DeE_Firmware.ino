...
/*
    ...
    3.03 1.0
      2018-12-07
      Light indicates voltage (1 - 4 blinks, 1 is empty, 4 is good)

    3.1
      2018-12-14
      Change in comm protocol - use Newline for commands
      LED now blinks to indicate voltage
 */
...
#define RA_PULSE_GUIDE_ARCSEC_PER_SEC 90000     //Was 50000
